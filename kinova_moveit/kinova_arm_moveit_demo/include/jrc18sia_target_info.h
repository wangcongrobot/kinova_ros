...
#define DESK_HEIGHT_LOW (0.30 - 0.41)
#define DESK_HEIGHT_MIDDLE (0.60 - 0.41)
#define DESK_HEIGHT_HIGH (0.90 - 0.41)
...
class JRCTarget
{
  public:
	JRCTarget()
	{
		...
		setTargetInfo(4, SWEEP, 0.220, 0.175, 0.060, 0, 0, 0.1, "chips");      // 薯片-袋装
		...
		setTargetInfo(13, SWEEP, 0.080, 0.038, 0.068, 0, 0, 0.1, "jelly");     // 果冻
