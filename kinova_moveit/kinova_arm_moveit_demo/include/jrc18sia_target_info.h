...
#define DESK_HEIGHT_HIGH (0.90 - 0.41 + 0.04)
...
class JRCTarget
{
  public:
	JRCTarget()
	{
		...
		setTargetInfo(0, SUCK, 0.145, 0.210, 0.006, 0, 0, 0.1, "book");        // 书
		...
		setTargetInfo(6, SUCK, 0.135, 0.092, 0.046, 0, 0, 0.1, "pacific");     // 太平苏打饼干
		...
		setTargetInfo(10, SUCK, 0.238, 0.055, 0.040, 0, 0, 0.1, "toothpaste"); // 牙膏
		setTargetInfo(11, SWEEP, 0.140, 0.095, 0.015, 0, 0, 0.1, "teether");   // 磨牙棒
		setTargetInfo(12, SWEEP, 0.065, 0.045, 0.106, 0, 0, 0.1, "milk");      // 牛奶
		setTargetInfo(13, SWEEP, 0.135, 0.05, 0.195, 0, 0, 0.1, "jelly");     // 果冻
