...
int main(int argc, char **argv) {
  ...
  //  feedback.ThetaX, feedback.ThetaY, feedback.Z]
  //  currentCartesianCommand = [0.212322831154, -0.257197618484,
  //  0.509646713734, 1.63771402836, 1.11316478252, 0.134094119072]
  tf::Pose Home;
  Home.setOrigin(tf::Vector3(0.212322831154, -0.257197618484, 0.509646713734));
  Home.setRotation(kinova::EulerXYZ2Quaternion(1.63771402836, 1.11316478252,
                                               0.134094119072));
  ...
  //  Home.setOrigin(tf::Vector3(0.212322831154, -0.257197618484,
  //  0.509646713734));
  //  Home.setRotation(tf::Quaternion(0.68463, -0.22436, 0.68808, 0.086576));
